package ru.surfstudio.standard.ui.screen
...
class FragmentScreenModule(private val persistentScope: FragmentViewPersistentScope) : ScreenModule() {
    ...
    @Provides
    @PerScreen
    internal fun provideChildFragmentNavigator(activityProvider: ActivityProvider,fragmentProvider: FragmentProvider):ChildFragmentNavigator{
